...
export interface CognitoNestedStackProps extends BaseNestedStackProps {
  // Additional cognito-specific props can be added here
}
...
export class CognitoNestedStack extends BaseNestedStack {
  ...
  constructor(scope: Construct, id: string, props: CognitoNestedStackProps) {
    ...
    this.userPool = new cognito.UserPool(this, 'UserPool', {
      userPoolName: `${this.environment}-${this.projectName}-users`,
      ...
      // User verification
      userVerification: {
        emailSubject: `Verify your email for ${this.projectName}`,
    ...
    this.userPoolClient = new cognito.UserPoolClient(this, 'UserPoolClient', {
      ...
      userPoolClientName: `${this.environment}-${this.projectName}-client`,
    ...
    this.userPoolDomain = new cognito.UserPoolDomain(this, 'UserPoolDomain', {
      userPool: this.userPool,
      cognitoDomain: {
        domainPrefix: `${this.environment}-${this.projectName}-${cdk.Aws.ACCOUNT_ID}`,
      },
    });
    ...
    new cdk.CfnOutput(this, 'UserPoolId', {
      ...
      exportName: `${this.environment}-user-pool-id`,
    });

    new cdk.CfnOutput(this, 'UserPoolClientId', {
      value: this.userPoolClient.userPoolClientId,
      description: 'Cognito User Pool Client ID',
      exportName: `${this.environment}-user-pool-client-id`,
    });

    new cdk.CfnOutput(this, 'UserPoolArn', {
      value: this.userPool.userPoolArn,
      description: 'Cognito User Pool ARN',
      exportName: `${this.environment}-user-pool-arn`,
    });

    new cdk.CfnOutput(this, 'UserPoolDomainUrl', {
      value: `https://${this.userPoolDomain.domainName}.auth.${cdk.Aws.REGION}.amazoncognito.com`,
      description: 'Cognito User Pool Domain URL',
      exportName: `${this.environment}-user-pool-domain-url`,
    });
